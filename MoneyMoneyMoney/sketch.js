...
class NPCRoom extends PNGRoom {
  preload() {
    ...
    this.npc2.addSingleInteraction("TAKE ME HOME");
    this.npc2.addSingleInteraction("im so pretty");
...
class Walkscreen2Room extends PNGRoom {
  preload() {
    ...
    lotto = new StaticSprite("lotto", 400,400, 'assets/lotto.png');
    this.hasSetup = false;
    // define class varibles here, load images or anything else
  }
  ...
  draw() {
    ...
    // this calls PNGRoom.draw()
    super.draw();
    drawSprite(lotto.sprite);

    // check for overlap
    if( playerAvatar.sprite.overlap(lotto.sprite) ) {
      playerAvatar.setGrabbable(lotto);
...
class Walkscreen1Room extends PNGRoom {
  preload() {
    ...
    dollar = new StaticSprite("dollar", 400,400, 'assets/dollar1.png');
    this.hasSetup = false;
    // define class varibles here, load images or anything else
  }
